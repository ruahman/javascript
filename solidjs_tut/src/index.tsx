...
import { Memo } from "./screens/Memo.tsx";
...
// New screens
import { CreateDeferred } from "./screens/CreateDeferred.tsx";
import { CreateSelector } from "./screens/CreateSelector.tsx";
import { CreateRenderEffect } from "./screens/CreateRenderEffect.tsx";
import { Reconcile } from "./screens/Reconcile.tsx";
import { CreateMutable } from "./screens/CreateMutable.tsx";
import { Unwrap } from "./screens/Unwrap.tsx";
import { OnError } from "./screens/OnError.tsx";
import { SuspenseListScreen } from "./screens/SuspenseList.tsx";
import { InnerHTML } from "./screens/InnerHTML.tsx";
import { EventNamespace } from "./screens/EventNamespace.tsx";
import { PropNamespace } from "./screens/PropNamespace.tsx";
import { UseNavigate } from "./screens/UseNavigate.tsx";
import { UseLocation } from "./screens/UseLocation.tsx";
import { UseSearchParams } from "./screens/UseSearchParams.tsx";
...
render(
  () => (
    <Router root={App}>
      ...
      {/* New routes */}
      <Route path="/create-deferred" component={CreateDeferred} />
      <Route path="/create-selector" component={CreateSelector} />
      <Route path="/create-render-effect" component={CreateRenderEffect} />
      <Route path="/reconcile" component={Reconcile} />
      <Route path="/create-mutable" component={CreateMutable} />
      <Route path="/unwrap" component={Unwrap} />
      <Route path="/on-error" component={OnError} />
      <Route path="/suspense-list" component={SuspenseListScreen} />
      <Route path="/inner-html" component={InnerHTML} />
      <Route path="/event-namespace" component={EventNamespace} />
      <Route path="/prop-namespace" component={PropNamespace} />
      <Route path="/use-navigate" component={UseNavigate} />
      <Route path="/use-location" component={UseLocation} />
      <Route path="/use-search-params" component={UseSearchParams} />
    </Router>
  ),
  root!,
);
