...
// a tuple is a fixed length array with mixed types

export default function tuples() {
  console.log("**** tuples ****");

  // define a tuple that has a number, boolean, and string
  ...
  // named tuples, if really doesnt change anything but makes code more readable
