...
export default () => {
  ...
  // a class or method should focus on doing one thing and only one thing only.
  //
  // example of what not to do in the same method or class:
  //    error handling
  //      should be handle in one place
  //    presentation
  //    persistance
};
